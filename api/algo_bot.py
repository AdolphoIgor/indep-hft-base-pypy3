...
class AlgoBot(Bot):
    ...
    def _create_position(self, dct_start_cfg: dict, thr: dict):
        ...
        keep_running = True
        while keep_running:
            # will stop another threads if just one of them had a rejection
            ...
            for msg in lst_received:
                ...
                '''
                    if this or any other thread got a rejected msg this will stop every thread for the actual robot.
